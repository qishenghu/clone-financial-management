    ...
    <div className={" flex flex-col " + className}>
      ...
      <Card className=" px-3 py-2 h-full overflow-hidden">
        ...
        {balances.length > 0 ? (
          ...
          <EmptyAlert href="/saldo">Click here to enter an account and its balance</EmptyAlert>
        )}
      </Card>
    </div>
  );
